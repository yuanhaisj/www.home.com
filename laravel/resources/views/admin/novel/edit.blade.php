        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.novel.doEdit')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">小说小说</label>
              <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="file" placeholder="小说封面" class="form-control" name="image_url"  /><img src="{{$novel->image_url}}" alt="" style="width:70px">
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <textarea name="desc"  class="form-control" style="border:none;" id="container">{{$novel->desc}}</textarea>
              </div>
            </div>
