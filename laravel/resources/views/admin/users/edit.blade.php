      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          ...
          <form class="form-horizontal form-bordered" action="{{route('admin.user.doEdit')}}" method="post" enctype="multipart/form-data">
           ...
           @if($user->is_super ==1) checked @endif> 否</label></div>
					 <div class="radio"><label><input type="radio" name="is_super" value="2" 
           @if($user->is_super ==2) checked @endif>是</label></div>
				  </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
					 <div class="radio"><label><input type="radio" name="status" value="1" @if($user->status ==1) checked @endif> 启用</label></div>
