...
class Controller
{
     ...
     * @param boolean $isPost 是否post的请求
    ...
    public function createSign($params)
    {
        ...
        //服务端生成签名
        unset($params['sign']);
        // $newSign=md5(http_build_query($params).$sercet);//函数的作用是使用给出的关联（或下标）数组生成一个经过 URL-encode 的请求字符串
